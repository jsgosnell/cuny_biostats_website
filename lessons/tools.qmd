...
Part 1 focused on getting used to R and git
...
## [Connected assignment(click here)](https://jsgosnell.github.io/cuny_biostats_book/content/primer_materials/R_primer.R){target="_blank"}

This link downloads an R primer file to work through. Git will explained during class sessions.

## [Lecture slides (click to open in Google slides!)](https://docs.google.com/presentation/d/1wtBVeCfy14k8xPH0fw8R70b_PCrGSY971I5wJm0Q79E/edit?usp=sharing
){target="_blank"}

Part 2 focused on getting used to Rmarkdown

```{=html}
<iframe src="https://docs.google.com/presentation/d/1wtBVeCfy14k8xPH0fw8R70b_PCrGSY971I5wJm0Q79E/embed?start=false&loop=false&delayms=3000" frameborder="0" width="1280" height="749" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
```
