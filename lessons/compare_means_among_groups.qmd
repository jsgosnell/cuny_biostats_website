...
subtitle: An introduction to linear models through ANOVAs, plus t-test connections
...
Here we will extend our focus on comparing populations to the analysis
of means (continuous outcomes). By the end of the lesson, students should be able to

-   note relationship between ANOVAs and t-tests and carry out each
-   note non-parametric alternatives to each test
...
-   [https://jsgosnell.github.io/cuny_biostats_book/content/chapters/Compare_means_among_populations.html](https://jsgosnell.github.io/cuny_biostats_book/content/chapters/Compare_means_among_populations.html){target="_blank"}
...
```{=html}
<iframe src="https://docs.google.com/presentation/d/e/2PACX-1vTEkMQy1Er4khof836FqroZQD0yByYNnWZztpWIGPJrGp5zBw8qkpRQqeC-aLlPY1RQ5ZOv829PbOCD/embed?start=false&loop=false&delayms=60000" frameborder="0" width="640" height="389" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
```
...
## [Connected assignment(click here)](https://jsgosnell.github.io/cuny_biostats_book/content/practice_problems/6_Compare_means.html){target="_blank"}
