...
Here we will connect our focus on comparing populations to the analysis of means.
...
-   <https://jsgosnell.github.io/cuny_biostats_book/content/chapters/Compare_means_among_populations.html>
...
-   then follow the on-screen prompts to select the JSG_swirl_lessons
    ...
    -   Here we will focus on the **Compare means among groups**
        lesson
